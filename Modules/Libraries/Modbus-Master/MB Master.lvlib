...
License: BSD (2-Clause) - http://opensource.org/licenses/BSD-2-Clause 
	...
	<Item Name="Master API" Type="Folder">
		<Item Name="Functions" Type="Folder">
			...
			<Item Name="Write Igus CanOpen.vi" Type="VI" URL="../MB_Master/Write Igus CanOpen.vi"/>
			<Item Name="Read Igus CanOpen.vi" Type="VI" URL="../MB_Master/Read Igus CanOpen.vi"/>
		</Item>
	...
	<Item Name="PDU" Type="Folder">
		<Item Name="Utility" Type="Folder">
			...
			<Item Name="Build PDUs" Type="Folder">
				...
				<Item Name="Build_Igus_CanOpen.vi" Type="VI" URL="../MB_PDU/Build_Igus_CanOpen.vi"/>
			</Item>
